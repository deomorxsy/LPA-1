...
Input: The input file contains a text (employee's first name), and two double precision values,
...
def main():
	...
	total_sal = fixed_salary + (0.15 * sales)

	return print("TOTAL = R$ {:.2f}".format(total_sal))
