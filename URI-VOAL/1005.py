...
Read two floating points' values of double precision A and B, corresponding to two student's
 ...
 decimal point. Don’t forget to print the end of line after the result, otherwise you will
 receive “Presentation Error”. Don’t forget the space before and after the equal sign.

Input: The input file contains 2 floating points' values with one digit after the decimal point.
Output: Print the message "MEDIA"(average in Portuguese) and the student's average
 according to the following example, with 5 digits after the decimal point and with
